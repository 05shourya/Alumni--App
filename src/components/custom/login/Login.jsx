...
const Login = ({ isLoggingIn }) => {
	...
	return (
		<>
			...
			<div className="card  p-10 px-20 mb-9">
				<img
					src="https://www.alliance.edu.in/school/school-of-liberal-arts/global-leaders-alliance/assets/logo/footer/university-logo-small-vertical-white-no-clear-space.svg"
					alt="University Logo"
